 ...
 * @date 2015-7-15
 */
public class MyInvestMentFragmentAdapter extends PagerAdapter implements OnPageChangeListener {
    ...
    public MyInvestMentFragmentAdapter(List<Fragment> fragments, FragmentManager fragmentManager, ViewPager viewPager) {
