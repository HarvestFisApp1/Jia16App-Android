 ...
 * 更多 ------消息中心 的公告界面
 */
public class AdvicesFragmnet extends BaseListFragment<Advices> {
    ...
    public Object requestData() {
        ...
        ArrayList<Advices> infos=(ArrayList<Advices>)JsonUtil.parseJsonToList(result,new TypeToken<List<Advices>>(){}.getType());
        if(infos!=null){
            if(list.size()%10==0){
    ...
    private String jsonStr="";
        private String postNewsDatas() {
                ...
                if (list.size() == 0) {
                    url = "/ums/cms/notice?page=1&pageLimit=10";
                } else {
                    int page=Integer.valueOf(list.size()/10).intValue()+1;
                    url = "/ums/cms/notice?page=" + page + "&pageLimit=10";
                }
