        ...
        if (checkClick(v.getId())) {
            ...
            if (checkParams(false)) {
                ...
                if(Util.isNetworkAvailable(this)){
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, jsonObject,
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                   ...
                                   AlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, "注册成功", new View.OnClickListener() {
                                       @Override
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            try {
                                ...
                                if (json != null) {
                                    ...
                                    if (message != null) {
                                        AlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, message, new View.OnClickListener() {
                                            @Override
                                        ...
                                        AlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, "注册失败", new View.OnClickListener() {
                                            @Override
                                            public void onClick(View view) {
                    ...
                    AlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, "网络异常，请检查网络连接后重试", new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
...
//        }
                ...
                JsonObjectRequest stringRequest=new JsonObjectRequest(Request.Method.POST, url, jsonObject,
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                //下发验证码成功
                                DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this,
                        ...
                        try {
                            ...
                            if(json!=null){
                                ...
                                if(message!=null){
                                    ...
                                    AlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, "获取验证码失败", new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
    ...
    private boolean checkParams(boolean getVerifyCode) {
        ...
        if (TextUtils.isEmpty(phoneNum)) {
            ...
            //手机号码为空
            DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, getString(R.string.find_pwd_phone_empty), false);
            return false;
        }
        ...
        if (!FormatUtil.isMobileNO(phoneNum)) {
            ...
            //手机号码格式不正确
            DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, getString(R.string.find_pwd_phone_format_error), false);
            return false;
        }
        ...
        if (TextUtils.isEmpty(verifyCode)) {
            ...
            DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, getString(R.string.find_pwd_code_empty), false);
            return false;
        }

        if (verifyCode.length() < 6) {

            DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, "验证码输入有误，请重新输入", false);
            return false;
        }

        if(TextUtils.isEmpty(RegistPwd)){
            DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this,"密码不能为空",false);
            return false;
        }

        if(RegistPwd.contains(" ")){
            //不能带有空格字符
            DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this,"密码格式不正确，或者密码不能为空",false);
            return false;
        }

        if(!FormatUtil.validateLoginPwd(RegistPwd)){
            DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this,"密码6-16个字符，区分大小写!");
            return false;
        }

        if (!mPwdSwitch.isChecked()) {

            DMAlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, "请先阅读服务条款并勾选！", false);
            return false;
        }
