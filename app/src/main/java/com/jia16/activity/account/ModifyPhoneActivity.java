...
public class ModifyPhoneActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        String startSubstring = modify_phone.substring(0, 3);
        String endSubstring = modify_phone.substring(7);
                ...
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, jsonObject,
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                //点击下一步按钮跳转到修改手机号界面
                                Intent intent = new Intent(ModifyPhoneActivity.this, ModifyPhoneNumActivity.class);
                        ...
                        try {
                            ...
                            if (json != null) {
                                ...
                                if (message != null) {
                                    ...
                                    AlertUtil.showOneBtnDialog(ModifyPhoneActivity.this, "验证失败", new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
